...
class FaceRectangle2 {
    public int x1, y1, x2, y2;
}

// Draw graphics on top of the video
class ProcessImageAndDrawResults2 extends View {
    public FSDK.HTracker mTracker;

    final int MAX_FACES = 5;
    final FaceRectangle2[] mFacePositions = new FaceRectangle2[MAX_FACES];
    ...
    int GetFaceFrame(FSDK.FSDK_Features Features, FaceRectangle2 fr)
    {
    ...
    public ProcessImageAndDrawResults2(Context context) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
		...
		*/
        ...
        for (int i=0; i<MAX_FACES; ++i) {
            mFacePositions[i] = new FaceRectangle2();
...
class Preview2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    Preview2(Context context, ProcessImageAndDrawResults draw) {
        super(context);
        mContext = context;
        mDraw = draw;
